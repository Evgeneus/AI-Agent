...
1. `search-agent/main.py` - example of simple ai agent (via create_agent function) with structured output 
...
6. `agentic-rag` - advanced agentic rag with router, web search
