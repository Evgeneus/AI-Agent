...
class AgentResponse(BaseModel):
    ...
    source: list[Source] = Field(
        default_factory=list, description="List of sources used to generate response"
    )


embeddings = OpenAIEmbeddings(model="text-embedding-3-small", retry_min_seconds=10)
